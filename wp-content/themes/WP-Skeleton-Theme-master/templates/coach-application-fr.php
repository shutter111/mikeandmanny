<?php
  ...
  $formData = get_field('coach_application_french', 2);

?>

<div id="coach-application-fr" class="modal fade">
	<div class="content-wrapper">
	  <div class="close-this-modal">X</div>	
	  <div class="center"><h2>Entraîneur</h2></div>
	  <form class="modal-form" data-email="<?php echo $formData[0]['email_to_send_data']?>">
	  	...
	  	<div id="coach-carousel" class="carousel slide" data-ride="carousel">
			...
			<div class="row form-submit">
				<div class="apply-btn">SOUMETTRE</div>
			</div>
    	</div><!-- END CAROUSEL -->		
	  </form> 
	</div>  
